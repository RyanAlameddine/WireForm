...
namespace WireForm.Circuitry.Gates
{
    class XorGate : Gate
    {
            ...
            : base(Position, new BoxCollider(-2, -1.5f, 4, 3))
        {
            ...
            Outputs = new GatePin[] {
                new GatePin(this, new Vec2(2, 0), BitValue.Error)
            };
        }
        ...
        protected override void draw(Graphics gfx)
        {
            ...
            gfx._DrawArcC(Color.Black, 10, Position.X - 2.5f - .75f, Position.Y, 5, 5, 321, 78);

            gfx._DrawArcC(Color.Black, 10, Position.X - 1.3f, Position.Y + 2, 8f, 7, 270, 60);
            gfx._DrawArcC(Color.Black, 10, Position.X - 1.3f, Position.Y - 2, 8f, 7, 90, -60);
        }
    }
}
